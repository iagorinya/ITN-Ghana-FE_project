...
# expt_name = f'{user}_FE_2022_example_w6aa'         ## change w6a or w6b
# expt_id = '64cbc8e2-fafd-ec11-a9fa-b88303911bc1'  ## change expt_id
# working_dir = os.path.join('simulation_outputs')
#
# serialize_years = 50  # Same as in run_exampleSim_w6a.py
#
# step = 'burnin'  # 'pickup'  # 'burnin'
#step = 'pickup'  # 'pickup'  # 'burnin'
user = os.getlogin()  # user initials
expt_name = f'{user}_FE_2022_pick_up4'  ## change w6a or w6b
expt_id = '57f18c66-9417-ed11-a9fb-b88303911bc1'  ## change expt_id
working_dir = os.path.join('simulation_outputs')

serialize_years = 4  # Same as in run_exampleSim_w6a.py
step = 'pickup'  # 'pickup'  # 'burnin'
