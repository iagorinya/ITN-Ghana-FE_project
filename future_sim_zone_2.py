...
pull_year = 50
years = 5
burnin_id = '952d378e-1332-ed11-a9fc-b88303911bc1'
serialize_year = 50
...
def case_management(cb, cm_cov_U5=0.69, cm_cov_adults=0.30, start_year=365):
    # Clinical cases
    #cm_cov_U5 = [0.69, 0.69, 0.69, 0.69, 0.69]

    for i in [start_year * 1, start_year * 2, start_year * 3, start_year * 4, start_year * 5]:
...
def itn_intervention(cb, coverage_level):
    seasonal_values = [0.032, 0.032, 0.032, 0.47, 0.47, 0.47, 0.25, 0.32, 0.47, 0.47, 0.47, 0.032]
    seasonal_times = [0, 30, 60, 91, 121, 152, 182, 213, 244, 274, 304, 364]
    deploy_year = 365
    for i in [deploy_year * 1, deploy_year * 3, deploy_year * 5]:
...
expt_name = f'{user}_FE_2022_futureSim_zone_2_{serialize_year}'
