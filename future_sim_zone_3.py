...
pull_year = 57
years = 8
burnin_id = 'd2682bcc-4232-ed11-a9fc-b88303911bc1'
serialize_year = 57
...
def case_management(cb, cm_cov_U5=0.69, cm_cov_adults=0.20, start_year=365):
    # Clinical cases
    # cm_cov_U5 = [0.69, 0.69, 0.69, 0.69, 0.69]
    for x in range(pickup_years):
        start_day = 0 + 365 * x

        # for i in [start_year * 10, start_year * 11, start_year * 3, start_year * 4, start_year * 5]:
        ...
        # Severe cases
        add_health_seeking(cb, start_day=start_day,
                           targets=[{'trigger': 'NewSevereCase', 'coverage': 0.7,
...
def itn_intervention(cb, coverage_level):
    seasonal_values = [0.032, 0.032, 0.032, 0.41, 0.41, 0.41, 0.032, 0.032, 0.41, 0.41, 0.41, 0.032]
    seasonal_times = [0, 30, 60, 91, 121, 152, 182, 213, 244, 274, 304, 364]
    deploy_year = 365
    # for i in [deploy_year * 1, deploy_year * 3, deploy_year * 6, deploy_year * 9]:
    for x in range(pickup_years):
        start_day = 0 + 365 * x
...
def irs_intervention(cb, coverage_level):
    deploy_year = 365
    for i in [deploy_year * 1, deploy_year * 2, deploy_year * 3, deploy_year * 4, deploy_year * 5, deploy_year * 6]:
              #deploy_year * 10, deploy_year * 11, deploy_year * 12, deploy_year * 13, deploy_year * 14, deploy_year * 15]:
        add_IRS(cb, start=i,
...
expt_name = f'{user}_FE_2022_futureSim_zone_3_{serialize_year}'
# expt_name = f'{user}_FE_2022_future_test_1'
