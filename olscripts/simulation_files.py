...
from sim_intervention import itn_intervention, irs_intervention
...
# Clinical cases
def case_management(cb, cm_cov_U5=0.6, cm_cov_adults=0.8):
    add_health_seeking(cb, start_day=366,
                       targets=[{'trigger': 'NewClinicalCase', 'coverage': 0.75,
...
add_IRS(cb,
        ...
        coverage_by_ages=[
            {"coverage": 0.8, "min": 0, "max": 10},  # 80% for 0-10 years old
            {"coverage": 0.7, "min": 11, "max": 50},  # 70% for 11-50 years old
